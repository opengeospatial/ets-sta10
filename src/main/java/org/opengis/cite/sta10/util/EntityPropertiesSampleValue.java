...
public class EntityPropertiesSampleValue {
	 ...
	 */
	public static final String[] LOCATION_PROPERTIES_Values = { "'location 2'", "'location 2'",
	...
	public static final Comparable[] HISTORICAL_LOCATION_PROPERTIES_Values = {
			ISODateTimeFormat.dateTime().parseDateTime("2015-10-14T21:30:00.104Z") };

	/**
	 * Sample properties for Datastream entity.
	 */
	public static final String[] DATASTREAM_PROPERTIES_Values = { "'datastream 1'", "'datastream 1'",
			"unitOfMeasurement", "'http://www.opengis.net/def/observationType/OGC-OM/2.0/OM_Measurement'" };

	/**
	 * Sample properties for Sensor entity.
	 */
	public static final String[] SENSOR_PROPERTIES_Values = { "'sensor 1'", "'sensor 1'", "'application/pdf'",
			"'Light flux sensor'" };

	/**
	 * Sample properties for ObservedProperty entity.
	 */
	public static final String[] OBSERVED_PROPETY_PROPERTIES_Values = { "'Luminous Flux'",
			"'http://www.qudt.org/qudt/owl/1.0.0/quantity/Instances.html/LuminousFlux'", "'observedProperty 1'" };

	/**
	 * Sample properties for Observation entity.
	 */
	public static final Comparable[] OBSERVATION_PROPERTIES_Values = {
			ISODateTimeFormat.dateTime().parseDateTime("2015-03-02T00:00:00.000Z"), "'2'",
	...
	public static final String[] FEATURE_OF_INTEREST_PROPERTIES_Values = {
			"'Generated using location details: location 1'", "'Generated using location details: location 1'",
	 ...
	 * @param index The index of the requested properties in the properties list of the
	 * entityType
	 * @return The sample value from the properties list of the given "entityType"
	 * positioned in location "index" in the list
	 */
