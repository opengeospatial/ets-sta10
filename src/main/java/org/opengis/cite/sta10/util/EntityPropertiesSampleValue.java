...
public class EntityPropertiesSampleValue {
    ...
    public static final String[] LOCATION_PROPERTIES_Values = {"'location 2'", "encodingType", "location" };
    ...
    public static final String[] OBSERVATION_PROPERTIES_Values = {"'2015-03-02T00:00:00.000Z'","'2'","resultTime"};
