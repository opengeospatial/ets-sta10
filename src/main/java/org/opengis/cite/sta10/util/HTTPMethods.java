...
public class HTTPMethods {
	 ...
	 * @return response-code and response(response body) of the HTTP GET in the MAP
	 * format. If the response is not 200, the response(response body) will be empty.
	 */
	...
	/**
	 * Send HTTP POST request to the urlString with postBody and return response code and
	 * response body
	 ...
	 * response is 201, the response will contain the self-link to the created entity.
	...
	/**
	 * Send HTTP PUT request to the urlString with putBody and return response code and
	 * response body
	 * @param urlString The URL that the PUT request should be sent to
	 * @param putBody The body of the PUT request
	 * @return response-code and response(response body) of the HTTP PUT in the MAP
	 * format. If the response is not 200, the response(response body) will be empty.
	 */
	 ...
	 * @return response-code of the HTTP DELETE in the MAP format. The MAP contains an
	 * empty response, in order to be consistent with what other HTTP requests return.
	 */
	...
	/**
	 * Send HTTP PATCH request to the urlString with patchBody and return response code
	 * and response body
	 * @param urlString The URL that the PATCH request should be sent to
	 * @param patchBody The body of the PATCH request
	 * @return response-code and response(response body) of the HTTP PATCH in the MAP
	 * format. If the response is not 200, the response(response body) will be empty.
	 */
